	...
	if($no_of_row > 0)
	{
		...
		foreach($result as $row)
		{
			if($row['user_email_status'] == 'not verified')
			{
				...
				if(isset($sub_result))
				{
					$message = '<label class="text-success">Your Email Address Successfully Verified <br />You can login here - <a href="https://www.esagar.in/login-my-dashboard-with-esagar.php">Login</a></label>';
				}
			}
			else
			{
...
<html>
	<head>
		<title>Esagar.in | Email Verification</title>		
	...
	<body>
		...
		<div class="container">
			<h1 align="center">Esagar.in | Email Verification</h1>
